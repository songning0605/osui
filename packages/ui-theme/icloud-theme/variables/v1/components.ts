export default {
    ...
    '--alert-padding': '8px 10px 8px 16px',
    ...
    '--btn-border-radius-base-sm': 'var(--border-radius-base)',
    ...
    '--form-item-extra-color': 'var(--theme-placeholder-color)',
    ...
    '--input-addon-bg': 'var(--color-gray-3)',
    ...
    '--modal-footer-button-group-gap': '8px',
    ...
    '--pagination-quick-jumper-margin-left': '8px',
    ...
    '--select-selection-item-bg': 'var(--color-gray-3)',
